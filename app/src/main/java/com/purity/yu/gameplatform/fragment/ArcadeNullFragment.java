 ...
 * 街机 马上有钱
 */
@ContentView(R.layout.fragment_arcade_beauty)
public class ArcadeNullFragment extends BaseFragment {
    ...
    protected void initView(View view) {
        ...
        initTableView();
        ArcadeLiveSocketController.getInstance().init(getActivity());
        ArcadeLiveSocketController.getInstance().connectSocket();
    }

    private void initTableView() {
        String _table = SharedPreUtil.getInstance(getActivity()).getString(Constant.ARCADE_NULL);
...
//                            return;
                    ...
                    intent.putExtra("ip", Constant.FISH2);
                    ...
                    SharedPreUtil.getInstance(getActivity()).saveParam(Constant.ARCADE_NULL, sb.toString());
                }
            }
        });
    }
