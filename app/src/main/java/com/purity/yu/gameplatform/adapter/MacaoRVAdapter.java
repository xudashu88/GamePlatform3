...
public class MacaoRVAdapter extends RecyclerView.Adapter<MacaoRVAdapter.ViewHolder> {
    ...
    public MacaoRVAdapter(Context context, List<Baccarat> baccaratList) {
...
//                ((MacauListActivity) mContext).finish();
            }
        });
...
//                cockroachRoadListAll, cockroachRoadList, cockroachRoadListShort, mContext, 2);//1房间 2大厅
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            tv_tie = (TextView) itemView.findViewById(R.id.tv_tie);
