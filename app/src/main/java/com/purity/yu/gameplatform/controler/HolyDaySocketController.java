 ...
 */
public class HolyDaySocketController {
...
//    }
    ...
    public static HolyDaySocketController getInstance() {
        if (null == instance) {
            instance = new HolyDaySocketController();
        }
        return instance;
    }
...
//                        boardMessageList = BaccaratUtil.getInstance().initBoardMessage(56, boardMessageList);
                                    postEventJoinRoom(boardMessageList, maxScoreList, _goldcoins, roomid, roomName, _betLimitStr, _maxBetStr, _minBetStr, stateHis, downtownTime, skyCard, betSecond, isPeopleNum, betsRemind);
    ...
    private void postEventJoinRoom(List<Integer> boardMessageList, List<Integer> maxScoreList, String _goldCoins, String roomId, String roomName, String[] betLimitList, String[] maxBetList, String[] minBetList,
                                   String state, int downtownTime, int skyCard, int betSecond, int isPeopleNum, int betsRemind) {
        ObjectEvent.BoardMessageEvent event = new ObjectEvent.BoardMessageEvent();
        event.boardMessageList = boardMessageList;
        event.maxScoreList = maxScoreList;
