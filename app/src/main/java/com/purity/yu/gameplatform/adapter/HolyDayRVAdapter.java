...
public class HolyDayRVAdapter extends RecyclerView.Adapter<HolyDayRVAdapter.ViewHolder> {
    ...
    public HolyDayRVAdapter(Context context, List<Baccarat> baccaratList) {
...
//                ((HolyDayListActivity) mContext).finish();
            }
        });
