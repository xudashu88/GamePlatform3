...
public class ArcadeBeautyFragment extends BaseFragment {
    ...
    private void initTableView() {
        String _table = SharedPreUtil.getInstance(getActivity()).getString(Constant.BEAUTY_AND_THE_BEAST);
...
//                    intent.putExtra("ip", Constant.BEAUTY_AND_THE_BEAST_IP);

                    Intent intent = new Intent(mContext, RobotFishActivity.class);
                    intent.putExtra("tag", tag);
                    intent.putExtra("ip", Constant.FISH_3);
                    ...
                    SharedPreUtil.getInstance(getActivity()).saveParam(Constant.BEAUTY_AND_THE_BEAST, sb.toString());
                }
            }
        });
    }
