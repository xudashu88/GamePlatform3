 ...
 * 街机 鳄鱼公园
 */
@ContentView(R.layout.fragment_arcade_crocilisk)
public class ArcadeCrocodileFragment extends BaseFragment {
...
//                    intent.putExtra("ip", Constant.CROCILISK_PARK_IP);
//                    mContext.startActivity(intent);
                    ...
                    SharedPreUtil.getInstance(getActivity()).saveParam(Constant.CROCILISK_PARK, sb.toString());
                }
            }
        });
    }
