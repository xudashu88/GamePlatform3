...
//        adapter.notifyItemChanged(event.position);
    ...
    private void postMessageList(final int type, final int page) {
        ...
        HttpRequest.request(SharedPreUtil.getInstance(mContext).getString(ServiceIpConstant.BASE) + Constant.MESSAGE_LIST + "?token=" + token/* + "&startDate=" + startDate + "&endDate=" + endDate*/)
