...
public class BaccaratRVAdapter extends RecyclerView.Adapter<BaccaratRVAdapter.ViewHolder> {
    ...
    public BaccaratRVAdapter(Context context, List<Baccarat> baccaratList) {
    ...
    public void onBindViewHolder(final BaccaratRVAdapter.ViewHolder holder, final int position) {
        ...
        holder.iv_bg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(mContext, BaccaratLiveActivity.class);
...
//                cockroachRoadListAll, cockroachRoadList, cockroachRoadListShort, mContext, 2);//1房间 2大厅
        ...
        Algorithm.getInstance().drawRoad(boardMessageList, bigRoadList, bigEyeRoadList, smallRoadList, cockroachRoadList,
                ...
                Color.RED, Color.BLUE, Color.GREEN, 0, false, 2);//列表不闪 国际
    }
