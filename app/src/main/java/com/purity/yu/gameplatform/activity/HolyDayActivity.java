...
@ContentView(R.layout.activity_holo_day)
public class HolyDayActivity extends BaseActivity implements CommonPopupWindow.ViewInterface {
    //https://jingyan.baidu.com/article/4dc40848e6a99ac8d946f13a.html 去水印 61.140.45.46
    //下注玩法一：老版本
    //发牌之前都可以取消下注，也可以续押
    //下注玩法二：新版本
    //和AG一样，下一次注可以确定和取消
    @BindView(R.id.rl_main_road)
    public RelativeLayout rl_main_road;
    @BindView(R.id.rl_record)
    public RelativeLayout rl_record;
    @BindView(R.id.tv_main_road_top)
    public TextView tv_main_road_top;
    ...
    @BindView(R.id.rl_bead_road)
    public RelativeLayout rl_bead_road;
    @BindView(R.id.tv_bead_road_top)
    public TextView tv_bead_road_top;
    @BindView(R.id.iv_bead_road_top)
    public ImageView iv_bead_road_top;
    @BindView(R.id.rl_all_road)
    public RelativeLayout rl_all_road;
    @BindView(R.id.tv_all_road_top)
    public TextView tv_all_road_top;
    @BindView(R.id.iv_all_road_top)
    public ImageView iv_all_road_top;
    ...
    @BindView(R.id.rl_main_road_layout)
    public RelativeLayout rl_main_road_layout;
    @BindView(R.id.rl_bead_road_layout)
    public RelativeLayout rl_bead_road_layout;
    @BindView(R.id.rl_all_record_layout)
    public RelativeLayout rl_all_record_layout;
    @BindView(R.id.rl_explain)
    public RelativeLayout rl_explain;
    ...
    @BindView(R.id.rl_road_dan)
    public RelativeLayout rl_road_dan;
    //赢后的变化
    ...
    @BindView(R.id.rl_road_change)
    public RelativeLayout rl_road_change;
    ...
    @BindView(R.id.rl_player_pair_chip1)
    RelativeLayout rl_player_pair_chip1;
    @BindView(R.id.cv_player_pair_chip1)
    ChipViewHoly cv_player_pair_chip1;
    @BindView(R.id.tv_player_pair_integer1)
    TextView tv_player_pair_integer1;
    ...
    @BindView(R.id.rl_banker_pair_chip1)
    RelativeLayout rl_banker_pair_chip1;
    @BindView(R.id.cv_banker_pair_chip1)
    ChipViewHoly cv_banker_pair_chip1;
    @BindView(R.id.tv_banker_pair_integer1)
    TextView tv_banker_pair_integer1;
    ...
    @BindView(R.id.rl_player_chip1)
    RelativeLayout rl_player_chip1;
    @BindView(R.id.cv_player_chip1)
    ChipViewHoly cv_player_chip1;
    @BindView(R.id.tv_player_integer1)
    TextView tv_player_integer1;
    @BindView(R.id.rl_player_chip2)
    RelativeLayout rl_player_chip2;
    @BindView(R.id.cv_player_chip2)
    ChipViewHoly cv_player_chip2;
    @BindView(R.id.tv_player_integer2)
    TextView tv_player_integer2;
    ...
    @BindView(R.id.rl_banker_chip1)
    RelativeLayout rl_banker_chip1;
    @BindView(R.id.cv_banker_chip1)
    ChipViewHoly cv_banker_chip1;
    @BindView(R.id.tv_banker_integer1)
    TextView tv_banker_integer1;
    @BindView(R.id.rl_banker_chip2)
    RelativeLayout rl_banker_chip2;
    @BindView(R.id.cv_banker_chip2)
    ChipViewHoly cv_banker_chip2;
    @BindView(R.id.tv_banker_integer2)
    TextView tv_banker_integer2;

    @BindView(R.id.iv_ld_bank_1)
    public ImageView iv_ld_bank_1;
    @BindView(R.id.iv_ld_bank_2)
    public ImageView iv_ld_bank_2;
    @BindView(R.id.iv_ld_bank_3)
    public ImageView iv_ld_bank_3;
    @BindView(R.id.iv_ld_play_1)
    public ImageView iv_ld_play_1;
    @BindView(R.id.iv_ld_play_2)
    public ImageView iv_ld_play_2;
    @BindView(R.id.iv_ld_play_3)
    public ImageView iv_ld_play_3;
    ...
    @BindView(R.id.tv_change_dealer)
    public TextView tv_change_dealer;
    ...
    private List<RelativeLayout> roadRlList;//换路（大路，珠路，下路）
    private List<RelativeLayout> cardList;//牌局（大路，珠路，下路）
    private List<ImageView> roadIvList;//换路（大路，珠路，下路）
...
//    }
    ...
    protected void initView(Bundle savedInstanceState) {
        this.mContext = HolyDayActivity.this;
        ...
        HolyDaySocketController.getInstance().init(this);
        HolyDaySocketController.getInstance().copyWidget(boardMessageList, tv_time, ll_poker, iv_banker_01, iv_banker_02, iv_banker_03,
                tv_jet_banker_value, iv_player_01, iv_player_02, iv_player_03, tv_jet_player_value, /*_calPlayer, _calBanker,*/ roomId,
                /*rl_sure,*/ rl_player_pair, rl_banker_pair, rl_player, rl_tie, rl_banker);
        HolyDaySocketController.getInstance().connectSocket();
        EventBus.getDefault().register(this);
        baccarat = (Baccarat) getIntent().getSerializableExtra("baccarat");
        init(mContext);
//        copyWidget(sv1, tv_middle_sv_l, tv_middle_sv_h, tv_big_sv_l, tv_big_sv_h, rl_road_change, baccarat);
        initEn();
        initEvent();

        chipImgList = new ArrayList<>();
        roadRlList = new ArrayList<>();
        cardList = new ArrayList<>();
        roadIvList = new ArrayList<>();
        selfChipValue();
        ...
        onInitRoad(rl_main_road);
        onInitRoad(rl_bead_road);
        onInitRoad(rl_all_road);
        cardList.add(rl_main_road_layout);
        cardList.add(rl_bead_road_layout);
        cardList.add(rl_all_record_layout);
        roadIvList.add(iv_main_top);
        roadIvList.add(iv_bead_road_top);
        roadIvList.add(iv_all_road_top);
    ...
    private void selfChipValue() {
        ...
        if (!TextUtils.isEmpty(SharedPreUtil.getInstance(mContext).getString(Constant.HOLY_DAY_CHIP))) {
            String macau = SharedPreUtil.getInstance(mContext).getString(Constant.HOLY_DAY_CHIP);
    ...
    private void initDisplay() {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                scaleX = 0.0f;
                topScaleY = 0.0f;
                if (rl_test.getWidth() > 0 && rl_top.getWidth() > 0) {
                ...
                if (_value2 / _value3 > 3) {
                    scaleY = 1 - _value3;
                    rl_bet.setScaleY(scaleY);
                } else if (_value2 / _value3 < 3 && _value2 / _value3 > 2) {
                    scaleY = 1 - _value1;
                    rl_bet.setScaleY(scaleY);
                ...
                tv_device.setText("scaleY=" + scaleY + " 1dp=" + mContext.getResources().getDimensionPixelOffset(R.dimen.unit1) + " V1=" + _value1 + " V2=" + _value2 + " V3=" + _value3);
                zoomReturnVideo();
            }
        }, 150);
    }

    private void setLayoutParamWH(RelativeLayout rl, float width, float height) {
        RelativeLayout.LayoutParams rl_player_params = (RelativeLayout.LayoutParams) rl.getLayoutParams();
        rl_player_params.width = (int) (displayMetrics.widthPixels * width);
        rl_player_params.height = (int) (displayMetrics.heightPixels * height);
        rl.setLayoutParams(rl_player_params);
    }
...
//                }, 100);
    ...
    public void acceptEventBoardMessage(final ObjectEvent.BoardMessageEvent event) {
        ...
        tv_limit.setText(String.valueOf(betLimitList.get(0)));
...
//        ask(0);//庄反闲
        ...
        HolyDaySocketController.getInstance().connectSocketProdict();
        mSocketProdict = HolyDaySocketController.getInstance().getSocketProdict();
    }
...
//                FlashHelper.getInstance().startFlick(rl_bank_light, 4);
    ...
    public void acceptEventChip(final ObjectEvent.ChipEvent event) {
        ...
        LogUtil.i("当前下注=2" + currentBetScore.toString());
...
//            perBig = currentBetScore.get(5);
//            bigScore = currentBetScore.get(5);
//            chipScore.put(5, currentBetScore.get(5));
//        } else if (currentBetScore.get(5) != perBig) {
//            rl_big_chip.setVisibility(View.VISIBLE);
//            perBig = currentBetScore.get(5);
//            cv_big_chip.addChip(0);
//            chipScore.put(5, currentBetScore.get(5));
//            tv_big_integer.setText("" + currentBetScore.get(5));
//            List<Integer> _bankerPairChip = new ArrayList<>();
...
//            perSmall = currentBetScore.get(6);
//            smallScore = currentBetScore.get(6);
//            chipScore.put(6, currentBetScore.get(6));
//        } else if (currentBetScore.get(6) != perSmall) {
//            rl_small_chip.setVisibility(View.VISIBLE);
//            perSmall = currentBetScore.get(6);
//            cv_small_chip.addChip(0);
//            chipScore.put(6, currentBetScore.get(6));
//            tv_small_integer.setText("" + currentBetScore.get(6));
//            List<Integer> _bankerPairChip = new ArrayList<>();
...
//        }
    ...
    private void initMessages() {
        ...
        AlgorithmHoly.getInstance().initBigRoad(boardMessageList, beadRoadList, beadRoadListShort,
                ...
                cockroachRoadListAll, cockroachRoadList, cockroachRoadListShort, mContext, 2, false,
                null, null, null, null, null, null);//1路单 2视频
    }
...
//        FlashHelper.getInstance().startFlick(iv_play_light_dot, 4);
//        FlashHelper.getInstance().startFlick(iv_bank_light_dot, 4);
//        FlashHelper.getInstance().startFlick(iv_play_pair_light_dot, 4);
//        FlashHelper.getInstance().startFlick(iv_bank_pair_light_dot, 4);
//        FlashHelper.getInstance().startFlick(iv_tie_light_dot, 4);
//    }

    private void onInitRoad(RelativeLayout rl) {
        roadRlList.add(rl);
        setRlOnClick(rl);
    }

    private void setRlOnClick(RelativeLayout rl) {
        rl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                for (int i = 0; i < roadRlList.size(); i++) {
                    TextView tv = (TextView) roadRlList.get(i).getChildAt(0);
                    tv.setVisibility(View.VISIBLE);
                    ImageView iv = (ImageView) roadRlList.get(i).getChildAt(1);
                    iv.setVisibility(View.GONE);
                    cardList.get(i).setVisibility(View.INVISIBLE);
                }
                RelativeLayout _rl = (RelativeLayout) v;
                if (_rl != null) {
                    String tag = (String) _rl.getTag();
                    TextView tv = (TextView) _rl.getChildAt(0);
                    tv.setVisibility(View.GONE);
                    ImageView iv = (ImageView) _rl.getChildAt(1);
                    iv.setVisibility(View.VISIBLE);
                    if (tag.equals("main")) {
                        rl_main_road_layout.setVisibility(View.VISIBLE);
                    } else if (tag.equals("bead")) {
                        rl_bead_road_layout.setVisibility(View.VISIBLE);
                    } else if (tag.equals("all")) {
                        rl_all_record_layout.setVisibility(View.VISIBLE);
                    }
                }
            }
        });
...
//        chipImgList.add(iv);
        ...
        iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (_iv != null) {
                    ...
                    SharedPreUtil.getInstance(mContext).saveParam(Constant.SELECT_CHIP_NUMBER_HOLY, Integer.parseInt(_tag[2]));
    ...
    private void initChip() {
        MyYAnimation animation = new MyYAnimation();
        animation.setRepeatCount(Animation.INFINITE);
        int chipDefault = SharedPreUtil.getInstance(mContext).getInt(Constant.SELECT_CHIP_NUMBER_HOLY);
        int realValue = Integer.parseInt(((String) chipImgList.get(0).getTag()).split("_")[2]);
        LogUtil.i("chipDefault-holy=" + chipDefault + " realValue=" + realValue);
        if (chipDefault == 0 || chipDefault < realValue) {
            ...
            SharedPreUtil.getInstance(mContext).saveParam(Constant.SELECT_CHIP_NUMBER_HOLY, minChipValue);
            iv_chip_10.startAnimation(animation);
        } else {
            int chip = SharedPreUtil.getInstance(mContext).getInt(Constant.SELECT_CHIP_NUMBER_HOLY);
            for (int i = 0; i < chipImgList.size(); i++) {
    ...
    private void initEvent() {
        ...
        rl_explain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                stopPlay();
        ...
        rl_sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isChip) {
                    ...
                    mSocket = HolyDaySocketController.getInstance().getSocket();
        ...
        rl_cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int allScore = currentBetScore.get(0) + currentBetScore.get(1) + currentBetScore.get(2) + currentBetScore.get(3) + currentBetScore.get(4) /*+ currentBetScore.get(5) + currentBetScore.get(6)*/;
                tv_bet_all_score.setText(String.valueOf(allScore));
                LogUtil.i("isFirstPlay3=" + isFirstPlay + "playerScore=" + playerScore + "perPlayer=" + perPlayer);
            }
        });
        //-----------------------------------------------------------------点击对应下注区域-start--------------------------------------------
...
//                        return;
        ...
        tv_switch_on.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tv_bank_odds.setText(R.string.banker_x2);
                free = 1;
            }
        });
        tv_switch_off.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tv_bank_odds.setText(R.string.banker_x195);
                free = 0;
            }
        });
        rl_road_dan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedPreUtil.getInstance(mContext).saveParam(Constant.BAC_VIDEO_PLAYING, 1);
//                stopPlay();
    ...
    private void betRobot() {
        ...
        LogUtil.i("isSwitchRobot=" + isSwitchRobot);//只下龙虎或者庄闲
        if (state.equals(Constant.BACCARAT_BET) && isSwitchRobot) {
            ...
            LogUtil.i("isSwitchRobot托管=" + chipScore.toString() + " state=" + state);
    ...
    private int initChipLayout() {
        int selectChipNumber = SharedPreUtil.getInstance(mContext).getInt(Constant.SELECT_CHIP_NUMBER_HOLY);
        if (isChip) {
            cleanChip();
        }
        isChipClick(true, true, R.drawable.button_bet_normal_bg, R.drawable.button_bet_normal_bg, R.string.confirm);
...
//        rl_small_chip.setVisibility(View.GONE);
    ...
    private void initEn() {
        ...
        if (languageType == LanguageType.LANGUAGE_EN) {
            ...
            tv_main_road_top.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.font8));
            tv_bead_road_top.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.font8));
            tv_all_road_top.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.font8));
            ...
            tv_change_dealer.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.font8));
        }
    }
...
//            hVideo = "rtmp://live.hkstv.hk.lxdns.com/live/hks1";
    ...
    private void initVideoEvent() {
        ...
        rl_road_change.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                ((HolyDayActivity) mContext).finish();
            }
        });
    }
...
//        savePlayerHandle.add(playerHandle);
        LogUtil.i("init playerHandle=新建" + playerHandle);
        if (playerHandle == 0) {
            return;
        }
        libPlayer.SetSmartPlayerEventCallbackV2(playerHandle, new EventHandleV2());
        libPlayer.SmartPlayerSetBuffer(playerHandle, playBuffer);
        libPlayer.SmartPlayerSetReportDownloadSpeed(playerHandle, 1, 5);//新加
        libPlayer.SmartPlayerSetFastStartup(playerHandle, isFastStartup ? 1 : 0);
        libPlayer.SmartPlayerSaveImageFlag(playerHandle, 1);//新加
        if (switchURL1 != null) {
        ...
        public void onNTSmartEventCallbackV2(long handle, int id, long param1, long param2, String param3, String param4, Object param5) {
            ...
            switch (id) {
                case NTSmartEventID.EVENT_DANIULIVE_ERC_PLAYER_STARTED:
                    Log.i(TAG, "开始。。" + mSv1.toString());
//                    initDefaultBackground();
                    break;
                case NTSmartEventID.EVENT_DANIULIVE_ERC_PLAYER_CONNECTING:
                    Log.i(TAG, "连接中。。" + mSv1.toString());
//                    initDefaultBackground();
                    break;
                case NTSmartEventID.EVENT_DANIULIVE_ERC_PLAYER_CONNECTION_FAILED:
                    Log.i(TAG, "连接失败。。" + mSv1.toString());
//                    initDefaultBackground();
                    break;
                case NTSmartEventID.EVENT_DANIULIVE_ERC_PLAYER_CONNECTED:
                    Log.i(TAG, "连接成功。。" + mSv1.toString());
//                    initNullBackground();
                    break;
                case NTSmartEventID.EVENT_DANIULIVE_ERC_PLAYER_DISCONNECTED:
                    Log.i(TAG, "连接断开。。" + mSv1.toString());
//                    initDefaultBackground();
                    break;
                case NTSmartEventID.EVENT_DANIULIVE_ERC_PLAYER_STOP:
                    Log.i(TAG, "停止播放。。" + mSv1.toString());
//                    initDefaultBackground();
                    break;
                case NTSmartEventID.EVENT_DANIULIVE_ERC_PLAYER_RESOLUTION_INFO:
                    Log.i(TAG, "分辨率信息: width: " + param1 + ", height: " + param2 + "   +mSv1.toString()=" + mSv1.toString());
//                    initNullBackground();
                    break;
                case NTSmartEventID.EVENT_DANIULIVE_ERC_PLAYER_NO_MEDIADATA_RECEIVED:
                    Log.i(TAG, "收不到媒体数据，可能是url错误。。" + mSv1.toString());
//                    initDefaultBackground();
                    break;
                case NTSmartEventID.EVENT_DANIULIVE_ERC_PLAYER_SWITCH_URL:
                    Log.i(TAG, "切换播放URL。。" + mSv1.toString());
//                    initDefaultBackground();
                    break;
                case NTSmartEventID.EVENT_DANIULIVE_ERC_PLAYER_START_BUFFERING:
                    Log.i(TAG, "Start_Buffering" + mSv1.toString());
                    break;
                case NTSmartEventID.EVENT_DANIULIVE_ERC_PLAYER_BUFFERING:
                    Log.i(TAG, "Buffering:" + param1 + "%" + mSv1.toString());
                    break;
                case NTSmartEventID.EVENT_DANIULIVE_ERC_PLAYER_STOP_BUFFERING:
                    Log.i(TAG, "Stop_Buffering" + mSv1.toString());
                    break;
            }
        }
    }
    ...
    private void initDefaultBackground() {
        ((HolyDayActivity) mContext).runOnUiThread(new Runnable() {
            @Override
            public void run() {
