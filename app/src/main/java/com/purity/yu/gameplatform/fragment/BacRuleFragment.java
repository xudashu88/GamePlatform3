...
public class BacRuleFragment extends BaseFragment {
    ...
    private void initWebView() {
        ...
        if (languageType == LanguageType.LANGUAGE_EN) {//3
            url = "file:///android_asset/bac_en.html";
        } else if (languageType == LanguageType.LANGUAGE_CHINESE_SIMPLIFIED||languageType == 0) {//1
            url = "file:///android_asset/bac_zh.html";
//            url = "http://gci.boinggame.com:81/agingame/?";
        } else if (languageType == LanguageType.LANGUAGE_CHINESE_TRADITIONAL){//2
            url = "file:///android_asset/bac_zh_rTW.html";
        }
        ...
        try {
            ...
            // myWebView.loadUrl("http://10.151.1.47/htmlfile/index.html");
