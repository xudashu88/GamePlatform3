 ...
 * 街机 渔乐世界
 */
@ContentView(R.layout.fragment_arcade_test)
public class ArcadeTestFragment extends BaseFragment {
    ...
    private void initTableView() {
        String _table = SharedPreUtil.getInstance(getActivity()).getString(Constant.ARCADE_TEST);
...
//                    intent.putExtra("ip", Constant.ARCADE_TEST_IP);
//                    mContext.startActivity(intent);
                    ...
                    SharedPreUtil.getInstance(getActivity()).saveParam(Constant.ARCADE_TEST, sb.toString());
                }
            }
        });
    }
