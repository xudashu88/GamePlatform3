...
import com.purity.yu.gameplatform.adapter.BaccaratRVAdapter2;
...
public class BaccaratListActivity2 extends BaseActivity {
    ...
    private BaccaratRVAdapter2 adapter;

    private String totalTable;

    @Override
    protected void initView(Bundle savedInstanceState) {
        mContext = BaccaratListActivity2.this;
        initView();
    }
    ...
    private void initAdapter() {
        ...
        adapter = new BaccaratRVAdapter2(mContext, baccaratList);
