 ...
 */
public class SinglePickLiveController {
    private Context mContext;
    private static SinglePickLiveController instance = null;
    private ChipAdapter mAdapter;
    private RecyclerView.LayoutManager mLayoutManager;
    private List<Chip> chipList;

    RecyclerView rv_new_chip;
    TextView tv_change_banker;
    ...
    public static SinglePickLiveController getInstance() {
        if (null == instance) {
            instance = new SinglePickLiveController();
        }
        return instance;
    }
