...
public class RockerView extends View {
    ...
    private void initAttribute(Context context, AttributeSet attrs) {
        ...
        // 可移动区域背景
        Drawable areaBackground = ContextCompat.getDrawable(context, R.drawable.rockertranslucentbg);
        ...
        // 摇杆背景
        Drawable rockerBackground = ContextCompat.getDrawable(context, R.drawable.handlepressed);
        ...
        // 摇杆半径
        //Drawable rockerBackground = ContextCompat.getDrawable(context, R.drawable.handlenormal);
        mRockerRadius = typedArray.getDimensionPixelOffset(R.styleable.RockerView_handlepressed, DEFAULT_ROCKER_RADIUS);
