 ...
 *
 */
public class GridRightMiddleLiveAdapter extends BaseAdapter {
	private Context mContext;
	private LayoutInflater layoutInflater;

	public GridRightMiddleLiveAdapter(Context mContext) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(mContext).inflate(R.layout.item_grid_right_middle_live, parent, false);
//			convertView =layoutInflater.inflate(R.layout.item_grid_right_middle,  null);
