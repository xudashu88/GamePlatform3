 ...
 *
 */
public class GridRightTopLiveAdapter extends BaseAdapter {
    private Context mContext;
    private LayoutInflater layoutInflater;

    public GridRightTopLiveAdapter(Context mContext) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_grid_right_top_live, parent, false);
