 ...
 *
 */
public class GridRightBottom1LiveAdapter extends BaseAdapter {
    private Context mContext;
    private LayoutInflater layoutInflater;

    public GridRightBottom1LiveAdapter(Context mContext) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_grid_right_bottom1_live, parent, false);
